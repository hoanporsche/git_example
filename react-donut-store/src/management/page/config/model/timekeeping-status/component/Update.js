...
class Update extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.timekeepingStatus) {
      const { timekeepingStatus } = this.props;
      this.setState({
        form: {
          id: { value: timekeepingStatus.id, valid: true },
          name: { value: timekeepingStatus.name, valid: true },
          description: { value: timekeepingStatus.description, valid: true },
        }
      })
    }
  }
        ...
        <div id="modal-update" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header"><h5>Update TimekeepingStatus</h5></div>
