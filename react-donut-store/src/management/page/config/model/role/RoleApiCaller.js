...
const findListUrl = baseUrl + API_URL.API + MODEL_URL.ROLE + API_URL.FIND_LIST;
const showOrNotUrl = baseUrl + API_URL.API + MODEL_URL.ROLE + API_URL.ENABLED_OR_NOT;
const saveUrl = baseUrl + API_URL.API + MODEL_URL.ROLE + API_URL.SAVE;
const findAllUrl = baseUrl + API_URL.API + MODEL_URL.ROLE + API_URL.FIND_ALL;

export const findListRole = (params) => {
