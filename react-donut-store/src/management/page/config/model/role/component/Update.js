...
import { save } from '../RoleApiCaller';
...
class Update extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.role) {
      ...
      this.setState({
        form: {
          id: { value: role.id, valid: true },
          name: { value: role.name, valid: true },
        }
      })
    }
  }
        ...
        <div id="modal-update" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header"><h5>Update Role</h5></div>
              <div className="modal-body">
                <CustomInput type="text" name="name" placeholder="Role's name" value={this.state.form.name.value}
