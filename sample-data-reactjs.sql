...
(1,'Bánh rán mặn', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569786/donut-store/banh-ran/BR7.jpg','1','2018-01-02', '2018-02-03','4000', b'1','Bánh rán với vỏ mỏng giòn; nhân bên trong có thịt, miến, mục nhĩ cùng các loại hương vị khác;bánh đi kèm nước sốt.'),
(2,'Bánh rán ngọt', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569777/donut-store/banh-ran/BR8.jpg','1','2018-01-02', '2018-02-03','4000', b'1','Bánh rán với nhân đỗ xanh quyện với đường cho vị ngọt thanh khi thưởng thức, vỏ bánh giòn mỏng.'),
(3,'Bánh mì pate trứng', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569683/donut-store/banh-mi/BM1.jpg','2','2018-01-02', '2018-02-03','12000', b'1','Bánh mì với nhân là pate, trứng chiên cùng các loại rau và sốt.'),
(4,'Bánh mì pate xúc xích', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569685/donut-store/banh-mi/BM2.png','2','2018-01-02', '2018-02-03','15000', b'1','Bánh mì với nhân là pate, xúc xích rán cùng các loại rau và sốt.'),
(5,'Bánh mì pate trứng xúc xích', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569686/donut-store/banh-mi/BM3.jpg','2','2018-01-02', '2018-02-03','18000', b'1','Bánh mì với nhân là pate, trứng chiên, xúc xích rán cùng các loại rau và sốt.'),
(6,'Trà đá', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569799/donut-store/do-uong/TRADA.jpg','3','2018-01-02', '2018-02-03','3000', b'1','Trà xanh ướp lạnh.'),
(7,'Mirrinda', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569798/donut-store/do-uong/MIRRINDA.jpg','3','2018-01-02', '2018-02-03','10000', b'1','Mirrinda ướp lạnh'),
(8,'Coca', 'https://res.cloudinary.com/hitkeodog/image/upload/v1533569798/donut-store/do-uong/COCA.jpg','3','2018-01-02', '2018-02-03','10000', b'1','Coca ướp lạnh');
