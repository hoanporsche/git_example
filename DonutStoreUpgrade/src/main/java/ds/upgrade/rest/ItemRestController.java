 ...
 */
@RestController
@RequestMapping(AppConstants.API_URL.MAIN_API + AppConstants.MODEL.ITEM_MODEL)
public class ItemRestController {
  ...
  public ResponseEntity<?> findList(Pageable pageable,
      ...
      @RequestParam(value = AppConstants.PARAM.CATEGORY_ID_PARAM, required = false) String categoryId) {
    try {
  ...
  public ResponseEntity<?> createOrUpdate(@RequestBody @Validated Item item,
    ...
    return new ResponseEntity<String>(AppConstants.REPONSE.NOT_RETRIVE_DATA, HttpStatus.BAD_REQUEST);
  }
