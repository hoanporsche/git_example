 ...
 */
@RestController
@RequestMapping(AppConstant.API_URL.MAIN_API + AppConstant.MODEL.MATERIAL_MODEL)
public class MaterialRestController {
  ...
  public ResponseEntity<?> findList(Pageable pageable,
      ...
      @RequestParam(value = AppConstant.PARAM.SUPPLY_ID_PARAM, required = false) String supplyId) {
    try {
