 ...
 */
@RestController
@RequestMapping(AppConstants.API_URL.MAIN_API + AppConstants.MODEL.MATERIAL_MODEL)
public class MaterialRestController {
  ...
  public ResponseEntity<?> findList(Pageable pageable,
      ...
      @RequestParam(value = AppConstants.PARAM.SUPPLY_ID_PARAM, required = false) String supplyId) {
    try {
