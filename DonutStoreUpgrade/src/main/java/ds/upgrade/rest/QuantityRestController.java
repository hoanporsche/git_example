 ...
 */
@RestController
@RequestMapping(AppConstants.API_URL.MAIN_API + AppConstants.MODEL.QUANTITY_MODEL)
public class QuantityRestController {
  ...
  public ResponseEntity<?> findAll(Pageable pageable,
      ...
      @RequestParam(value = AppConstants.PARAM.ITEM_ID_PARAM, required = false) String itemId,
